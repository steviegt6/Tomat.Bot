...
{
    public sealed class RandomWebsiteCommand : TomatCommand
    {
        public override MethodInfo? AssociatedMethod => GetType().GetMethod("HandleCommand");

        public override HelpCommandData HelpData => new("randomwebsite", "Links the user to a random website from a list of websites provided by [TheUselessWeb](https://theuselessweb.com/).");
