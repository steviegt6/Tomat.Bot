...
namespace TomatBot.Core.Utilities
{
    public static class CommandUtilities
    {
        ...
        public static bool HasValidPrefix(SocketUserMessage message, out InvalidMessageReason invalidReason, out int argumentPosition, DiscordSocketClient? mentionClient = null)
        {
            argumentPosition = 0;
            invalidReason = InvalidMessageReason.NoError;

            if (message.HasStringPrefix(BotStartup.DefaultPrefix, ref argumentPosition, StringComparison.OrdinalIgnoreCase)
        ...
        public static bool CheckAutomaton(this SocketUserMessage message, out InvalidMessageReason invalidReason, bool allowBots = false, bool allowWebhooks = false)
        {
